...
HEX_TARGET = hexagon
TEST_TARGET = test_client test_server

all: $(CLIENT_TARGET) $(SERVER_TARGET) $(HEX_TARGET) $(TEST_TARGET)
...
$(HEX_TARGET): $(HEX_OBJS)
	$(CC) $(CFLAGS) -o $(HEX_TARGET) $(HEX_OBJS)
...
clean:
	rm -f $(ALL_OBJS) $(CLIENT_TARGET) $(SERVER_TARGET) $(HEX_TARGET) $(TEST_TARGET)
